...
- GitHub Exposure Signals — POST https://hustleos-x402-feed.coolbladez05.workers.dev/v1/github/exposure-signals — $0.01 USDC; defensive output contains aggregate categories and paths only, never values
